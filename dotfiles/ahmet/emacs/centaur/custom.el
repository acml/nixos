...
(setq centaur-full-name "Ahmet Cemal Özgezer")           ; User full name
(setq centaur-mail-address "ahmet.ozgezer@andasis.com")   ; Email address
...
(when (display-graphic-p)
  ;; Set default font
  (cl-loop for font in '("Iosevka" "SF Mono" "Hack" "Source Code Pro" "Fira Code"
